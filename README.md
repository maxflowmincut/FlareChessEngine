...
Flare Engine is a free and open source UCI chess engine, rewritten from my older C++ engine and updated for C++23. It includes a local web interface in Go using WebSockets for play against the engine.
